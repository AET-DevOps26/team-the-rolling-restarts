...
- ✅ GenAI unit tests — `services/gen-ai/tests/test_health.py`, `test_summarize.py`, `test_explain.py`, `test_sentiment.py`, `test_qa.py`, `test_observability.py`, `test_metrics.py`, `test_upstream_errors.py` (offline mocked pytest)
...
3. **No client tests** — Spring and GenAI have real test coverage; `web-client` still
